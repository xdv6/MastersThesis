...
```python main_tree.py --epochs 100 --log_dir ./runs/test_frozen_down_right --dataset frozen_lake --lr 0.001 --lr_block 0.001 --lr_net 1e-5 --num_features 11 --depth 4 --net vgg11 --freeze_epochs 30 --milestones 60,70,80,90,100```
